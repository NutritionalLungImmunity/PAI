...
#ifndef EDU_UF_COMPARTMENTS_MACROPHAGERECRUITER_H_
#define EDU_UF_COMPARTMENTS_MACROPHAGERECRUITER_H_
...
class MacrophageRecruiter : public Recruiter {
public:
...
#endif /* EDU_UF_COMPARTMENTS_MACROPHAGERECRUITER_H_ */
