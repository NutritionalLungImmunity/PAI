...
#ifndef EDU_UF_INTERACTABLE_TNFA_H_
#define EDU_UF_INTERACTABLE_TNFA_H_
...
class TNFa : public Molecule {
public:
    static const string NAME;
    static const int NUM_STATES;

    static TNFa* getMolecule(Diffuse* diffuse = nullptr, int xbin = -1, int ybin = -1, int zbin  = -1, char wbin = -1);
...
private:
    TNFa(double**** qttys, int xbin, int ybin, int zbin, char wbin, Diffuse* diffuse);
    static TNFa* molecule;
...
#endif /* EDU_UF_INTERACTABLE_TNFA_H_ */
