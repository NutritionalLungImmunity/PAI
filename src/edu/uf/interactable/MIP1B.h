...
#ifndef EDU_UF_INTERACTABLE_MIP1B_H_
#define EDU_UF_INTERACTABLE_MIP1B_H_
...
class MIP1B : public Chemokine {
public:
    static const string NAME;
    static const int NUM_STATES;

    static MIP1B* getMolecule(Diffuse* diffuse = nullptr, int xbin = -1, int ybin = -1, int zbin  = -1, char wbin = -1);
...
private:
    MIP1B(double**** qttys, int xbin, int ybin, int zbin, char wbin, Diffuse* diffuse);
    static MIP1B* molecule;
...
#endif /* EDU_UF_INTERACTABLE_MIP1B_H_ */
