...
#ifndef EDU_UF_INTERACTABLE_TRANSFERRIN_H_
#define EDU_UF_INTERACTABLE_TRANSFERRIN_H_
...
class Transferrin : public Molecule {
public:
    static const string NAME;
    static const int NUM_STATES = 3;
    static const double THRESHOLD;

    static Transferrin* getMolecule(Diffuse* diffuse = nullptr, int xbin = -1, int ybin = -1, int zbin  = -1, char wbin = -1);
...
#endif /* EDU_UF_INTERACTABLE_TRANSFERRIN_H_ */
