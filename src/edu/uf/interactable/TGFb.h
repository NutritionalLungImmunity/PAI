...
#ifndef EDU_UF_INTERACTABLE_TGFB_H_
#define EDU_UF_INTERACTABLE_TGFB_H_
...
class TGFb : public Molecule {
public:
    static const string NAME;
    static const int NUM_STATES;

    static TGFb* getMolecule(Diffuse* diffuse = nullptr, int xbin = -1, int ybin = -1, int zbin  = -1, char wbin = -1);
...
private:
    TGFb(double**** qttys, int xbin, int ybin, int zbin, char wbin, Diffuse* diffuse);
    static TGFb* molecule;
...
#endif /* EDU_UF_INTERACTABLE_TGFB_H_ */
