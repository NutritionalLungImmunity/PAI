			...
			network = new BooleanNetwork() {
				...
				public void processBooleanNetwork() {
					...
					if(this.booleanNetwork[NFkB] > 0 || this.booleanNetwork[STAT1] > 0 || this.booleanNetwork[STAT5] > 0)
						this.getPhenotype().put(Macrophage.this.M1, this.or(new int[] {this.booleanNetwork[NFkB], this.booleanNetwork[STAT1], this.booleanNetwork[STAT5]}));
					if(this.booleanNetwork[STAT6] > 0)
						this.getPhenotype().put(Macrophage.this.M2A, this.booleanNetwork[STAT6]);
					if(this.booleanNetwork[ERK] > 0)
						this.getPhenotype().put(Macrophage.this.M2B, this.booleanNetwork[ERK]);
					if(this.booleanNetwork[STAT3] > 0)
						this.getPhenotype().put(Macrophage.this.M2C, this.booleanNetwork[STAT3]);
					//else
